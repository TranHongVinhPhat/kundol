...
// Remove cart
var remove_cart = document.getElementsByClassName("fa-trash");
...
for (var i = 0; i < remove_cart.length; i++) {
    ...
    button.addEventListener("click", function() {
        ...
        updatecart()
        var cartItems = document.getElementById('dropcart')
        var cart_title = cartItems.getElementsByClassName('cart-item-title')
        var item_count = document.getElementsByClassName('item-count')
        var count = 0
        for (var i = 0; i < cart_title.length; i++) {
            count = item_count[i].innerHTML--
                return count
        }
        if (cart_title.length == 0) {
            count = item_count[i].innerHTML = 0
        }
...
function updatecart() {
    var cart_item = document.getElementsByClassName("shopping-cart-items")[0];
    var cart_rows = cart_item.getElementsByClassName("item-s");
    var total = 0;
    ...
    for (var i = 0; i < cart_rows.length; i++) {
        ...
        var quantity_item = cart_row.getElementsByClassName('quantity')[0]
        var price = parseFloat(price_item.innerText)
        var quantity = parseFloat(quantity_item.innerText)
        total = total + (price * quantity)
    }

    document.getElementsByClassName("total")[0].innerText = '$' + total + '.00'
}
...
//quantity
var quantity_item = document.getElementsByClassName("quantity");
for (var i = 0; i < quantity_item.length; i++) {
    var quantity = quantity_item[i];
...
var add_cart = document.getElementsByClassName('icon-shop');
for (var i = 0; i < add_cart.length; i++) {

    var add = add_cart[i];
    add.addEventListener("click", function(event) {
        var button = event.target;
        var product = button.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement;
        var img = product.getElementsByClassName('img-fluid')[0].src
        var title = product.querySelector("h3").innerText
        var price_cart = product.querySelector("ins")
        var price = price_cart.querySelector("a").innerText
        addItemToCart(img, title, price)
        console.log(img, title, price, product)
        updatecart()
    })
}
var detail_add_cart = document.getElementsByClassName('add-detail');
for (var i = 0; i < detail_add_cart.length; i++) {

    var detail_add = detail_add_cart[i];

    detail_add.addEventListener("click", function(event) {
        var button = event.target;
        var product = button.parentElement.parentElement.parentElement.parentElement.parentElement;
        var img = product.getElementsByClassName('img-active')[0].src
        var title = product.querySelector("h3").innerText
        var price_cart = product.querySelector("ins")
        var price = price_cart.querySelector("a").innerText
        addItemToCart(img, title, price)
...
//wishlish.html
var add_cart_wishlist = document.getElementsByClassName('add-wishlish')
for (var i = 0; i < add_cart_wishlist.length; i++) {

    var add_wishlist = add_cart_wishlist[i];
    add_wishlist.addEventListener("click", function(event) {
        var button = event.target;
        var product = button.parentElement.parentElement;
        var img = product.getElementsByClassName('img-wish')[0].src
        var title = product.querySelector("h3").innerText
        var price = product.querySelector("a").innerText
        addItemToCart(img, title, price)
        updatecart()
        console.log(img, title, price, product)
    })
...
var sale_add_cart = document.getElementsByClassName('add_sale');
for (var i = 0; i < sale_add_cart.length; i++) {

    var sale_add = sale_add_cart[i];

    sale_add.addEventListener("click", function(event) {
        var button = event.target;
        var product = button.parentElement.parentElement.parentElement.parentElement.parentElement;
        var img = product.getElementsByClassName('img-fluid')[0].src
        var title = product.querySelector("h3").innerText
...
var add_cart_wish = document.getElementsByClassName('icon-heart')
var item_count = document.getElementsByClassName('item-count-wish')
for (var i = 0; i < add_cart_wish.length; i++) {
    var add_wish = add_cart_wish[i];
    add_wish.addEventListener("click", function(event) {
        var button = event.target;
        var product = button.parentElement.parentElement.parentElement.parentElement.parentElement;
        var img = product.getElementsByClassName('img-fluid')[0].src
        var title = product.querySelector("h3").innerText
        var price_cart = product.querySelector("ins")
        var price = price_cart.querySelector("a").innerText
            // addItemToCartWish(img,title,price)
        console.log(img, title, price)
        var i = 0
        item_count[i].innerHTML++
    })


}

var add_product_wish = document.getElementsByClassName('Add-to-wishlist')
for (var i = 0; i < add_product_wish.length; i++) {
    var product_wish = add_product_wish[i];
    product_wish.addEventListener("click", function(event) {
        var button = event.target;
        var product = button.parentElement.parentElement.parentElement.parentElement.parentElement;
        var img = product.getElementsByClassName('img-active')[0].src
...
var add_product_cart = document.getElementsByClassName('add-product-cart')
var item_count = document.getElementsByClassName('item-count-wish')
for (var i = 0; i < add_product_cart.length; i++) {
    var product_cart = add_product_cart[i];
    product_cart.addEventListener("click", function(event) {
        var button = event.target;
        var product = button.parentElement.parentElement.parentElement.parentElement.parentElement;
        var img = product.getElementsByClassName('img-active')[0].src
        var title = product.querySelector("h2").innerText
...
function addItemToCart(img, title, price) {
    ...
    var cart_title = cartItems.getElementsByClassName('cart-item-title')
        //count cart dropcart
    var cart_quantity = cartItems.getElementsByClassName('quantity')
    for (var i = 0; i < cart_title.length; i++) {
        if (cart_title[i].innerText == title) {
            cart_quantity[i].innerHTML++
                return
        }
    ...
    <div class="item-thumb">
        <div class="image">
            <img class="img-fluid" src="${img}" alt="Product Image">
        </div>
        </div><div class="item-detail">
            <h3 class="cart-item-title">${title}</h3>
            <div class="item-s">
            <span class="quantity">1</span>
            <span style="margin-left: -27%;">x $</span>
            <span class="price" style="margin-left: -30%;">${price}.00</span> 
    ...
    cartRow.getElementsByClassName('fa-trash')[0].addEventListener('click', function() {
        var button_remove = event.target
        button_remove.parentElement.parentElement.parentElement.remove()
        updatecart()
        var item_count = document.getElementsByClassName('item-count')
    ...
    cartRow.getElementsByClassName('quantity')[0].addEventListener('change', function(event) {
...
// function addItemToCartWish(img,title,price){
//     var cart_title = cartItems.getElementsByClassName('cart-item-title')
// //     var cartRow = document.createElement('tr')
// //     cartRow.classList.add('d-flex')
// //     // import wish from 'wishlist.html'
// //     var cartItems = wish.getElementsByClassName('top-table')
// //     var cartRowContents =`

// //         <td class="col-12 col-lg-2">
// //             <img class="img-fluid img-wish" src="${img}" alt="WishList">
// //         </td>
...
// //             </div>
// //         </td>
// //         <td class="col-12 col-lg-2 item-price">$<a>${price}</a></td>
// //         <td class="col-12 col-lg-2 text-success">In stock</td>

// //         <td class="col-12 col-lg-3 align-middle">

// //             <button type="button" class="btn btn-secondary btn-lg add-wishlish " onclick="notificationCart();">Add to Cart</button>
// //         </td>`
// //     cartRow.innerHTML = cartRowContents
// //     cartItems.append(cartRow)
// //     console.log(cartItems)
